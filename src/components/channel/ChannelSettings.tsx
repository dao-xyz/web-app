 ...
 */
export const ChannelSettings: FC<{ channel: Shard<PostInterface>, /* authorities: ChannelAuthorityAccount[], authoritiesByType: Map<AuthorityType, AccountInfoDeserialized<ChannelAuthorityAccount>[]> */ }> = ({ channel,/*  authorities, authoritiesByType */ }) => {
    /* 
        ...
        const [loadingAuthority, setLoadingAuthority] = useState<ChannelAuthorityAccount | undefined>(undefined);
        ...
        const authorityCondition = (authority: ChannelAuthorityAccount) => {
            if (!authority?.data) {
        ...
        const deleteAuthority = async (authority: ChannelAuthorityAccount) => {
